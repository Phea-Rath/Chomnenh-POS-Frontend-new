...
const Footer = () => {
    return (
        <footer className="bg-chomnenh-dark text-white">
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    {/* <div>
                        ...
                        <div className="flex">
                            <input
                                ...
                                className="px-3 py-2 bg-gray-100 text-black rounded-l-lg focus:outline-none flex-1"
                            />
                    ...
                    <div className='flex flex-row sm:flex-col sm:justify-center sm:items-center justify-start items-center gap-2'>
                        <img src={logo} alt="Logo" className='w-10 sm:w-20 h-10 sm:h-20  rounded-full' />
