...
import { useGetAllItemInStockQuery, useGetAllItemsQuery } from "@/features/products/itemsSlice";
...
const UpdateOrders = () => {
  ...
  const handleConfirmUpdate = async () => {
    ...
    try {
      ...
      // Update order
      const orderRes = await updateOrder({ id, itemData: payload, token }).unwrap();
                  ...
                  <div className="overflow-x-auto">
                    {selectedItems?.length === 0 ? (
                      ...
                      <table className={`min-w-full divide-y ${darkMode ? "divide-gray-700" : "divide-gray-200"}`}>
                        <thead className={darkMode ? "bg-primary" : "bg-gradient-to-r from-gray-50 to-cyan-50"}>
                          <tr>
                              ...
                              <td className="px-4 py-4">
                                <div className="flex items-center">
                                  {/* <input
                                    ...
                                    className={`w-20 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-center ${
                                      darkMode 
                                  ...
                                  <Input
                                    ...
                                    value={item.quantity}
                                    onChange={(e) => handleItemChange(index, "quantity", e.target.value, item.id)}
                                    className={`w-20 px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-center ${darkMode
                                        ? "bg-gray-700 border-gray-600 text-white"
                                        : "bg-white border-gray-300"
                                      }`}
                                  />
                  ...
                  <div className="space-y-4 flex flex-wrap gap-3">
                    ...
                    <div className="grow">
                      ...
                      <Input
                        ...
                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 ${darkMode ? "bg-gray-700 border-gray-600 text-white" : "bg-white border-gray-300 text-gray-900"}`}
                      />
                    </div>
                    <div className="grow">
                      <label className={`block text-sm font-medium mb-2 ${darkMode ? "text-gray-400" : "text-gray-700"}`}>
                    ...
                    <div className="grow">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className={`w-full pl-8 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent ${darkMode
                              ? "bg-gray-700 border-gray-600 text-white"
                              : "bg-white border-gray-300"
                            }`}
                          placeholder="0.00"
                    ...
                    <div className="grow w-full">
                      ...
                      <textarea
                        ...
                        className="textarea-input w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 bg-white dark:bg-slate-700 text-gray-900 dark:text-gray-100"
                        rows={2}
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          ...
                          <span className={`font-medium ${form.sale_type === 'sale' ? 'text-green-600' : 'text-cyan-600'}`}>
