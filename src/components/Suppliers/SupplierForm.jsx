...
} from "@/features/purchases/suppliesSlice";
...
const SupplierForm = () => {
  ...
  const textareaClasses = "w-full px-4 py-2 bg-transparent text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-400 rounded-sm outline-none transition-all focus:ring-4 focus:ring-cyan-500/10 focus:border-cyan-500 min-h-[100px]";
