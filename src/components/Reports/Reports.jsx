    ...
    >
      <section className="p-4 md:p-8">
        <header className="mb-8">
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">{t("reportsDashboard")}</h1>
          <p className="text-gray-500 dark:text-gray-400 mt-1">{t("selectReportAnalytics")}</p>
        </header>
