        ...
        <div className="min-h-screen bg-transparent p-1 md:p-3">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 ml-2">
                    ...
                    <p className="text-gray-600 mt-2">Generate and export stock reports</p>
                </div>
                            ...
                            {reportData?.length > 0 && (
                                <div className="mt-6 p-4 bg-gray-50 rounded-md">
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                        <div>
                                            <span className="font-medium text-gray-700">Total Stock Entries: </span>
                ...
                {!reportData && !loading && (
                    <div className="bg-white rounded-lg shadow-md p-12 text-center">
                        ...
                        <p className="text-gray-500">Use the filters above to generate a stock report</p>
                    </div>
                )}
