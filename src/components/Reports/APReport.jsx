    ...
    return (
        <div className="min-h-screen bg-transparent p-2 md:p-4">
            <div className="max-w-7xl mx-auto">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-slate-900">Account Payables Report</h1>
                    <p className="text-slate-500 text-sm mt-1">Track suppliers, balances, and payment status</p>
                </div>
                ...
                {!reportData && !loading && (
                    <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-12 text-center">
                        ...
                        <p className="text-slate-500">Use the filters above to generate an account payables report</p>
                    </div>
                )}
