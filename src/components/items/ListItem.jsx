  ...
  return (
    <div className="items-page bg-transparent pb-5">
      ...
      <div className=" mx-auto border-gray-200 p-3">
        <div className="mx-auto flex justify-between items-start md:items-center gap-4">
          <div>
          ...
          <div className="flex gap-3 justify-end md:w-auto">
            {/* <Button
      ...
      <div className="mx-auto px-2 mt-2">
        <div className=" mx-auto flex flex-col items-center lg:flex-row gap-4 mb-6">
          <div className="grow h-10 w-full relative">
            <input
              placeholder={t("Search products...")}
              className="w-full h-full pl-10 pr-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-transparent text-sm"
              value={searchTerm}
        ...
        <div className="flex gap-2 overflow-x-auto !scroll-none mb-6 pb-1">
          <button
