...
const StockRawForm = () => {
    ...
    async function handleConfirm() {
        ...
        try {
            ...
            let response;
            if (isEditMode) {
                response = await updateStockRaw({ id, itemData: payload, token }).unwrap();
            } else {
                response = await createStockRaw({ itemData: payload, token }).unwrap();
            }

            if (response?.status === 200 || response?.data?.status === 200 || response) {
                refetchStockRaw();
                if (isEditMode && refetchStockRawById) refetchStockRawById();
                if (refetchRawMaterials) refetchRawMaterials();
                setLoading(false);
                notify.success(
                    response?.data?.message || response?.message || (isEditMode ? t('stockRawUpdatedSuccess') : t('stockRawCreatedSuccess'))
                );
                navigator(-1);
            }
        } catch (error) {
            ...
            <div className=" mx-auto overflow-visible">
                ...
                <div className="mb-8 overflow-visible">
                    <div className="flex justify-between items-center mb-4 overflow-visible">
                        <div>
                            <MdLocalShipping className="text-2xl text-cyan-600 dark:text-cyan-400" />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div className="lg:col-span-2">
                                    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-sm overflow-visible">
                                        {/* Items Header */}
                                        <div className="px-6 py-4 bg-gradient-to-r from-cyan-50 to-purple-50 dark:from-cyan-900/20 dark:to-purple-900/20 border-b border-gray-200 dark:border-gray-700">
                                        ...
                                        {selectMaterials.length > 0 ? (
                                            ...
                                            <div className="text-center py-16">
                                                <div className="w-24 h-24 bg-gradient-to-r from-cyan-100 to-purple-100 dark:from-cyan-900/20 dark:to-purple-900/20 rounded-full flex items-center justify-center mx-auto mb-6">
                                                    <FaFlask className="text-3xl text-cyan-500 dark:text-cyan-400" />
                                                </div>
                                    ...
                                    {selectMaterials.length > 0 && (
                                        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <div className="bg-cyan-50 dark:bg-cyan-900/20 border border-cyan-100 dark:border-cyan-900/30 rounded-xl p-4">
                                                <div className="text-sm text-cyan-800 dark:text-cyan-400 mb-1">{t('totalQuantity')}</div>
                                ...
                                <div className="lg:col-span-1 space-y-6">
                                    ...
                                    <div className="">
                                        <h3 className="font-medium text-gray-800 dark:text-white flex items-center gap-2">
                                            <FaEdit className="text-cyan-500 dark:text-cyan-400" />
                                            {t('stockDetails')}
                                        </h3>
                                        ...
                                        <div className="space-y-4 flex flex-wrap gap-3 items-center">
                                            {/* <div>
                                                ...
                                                <select
                                                    ...
                                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white dark:bg-gray-700 dark:text-white text-sm"
                                                    required
                                                >
                                            ...
                                            <div className="grow">
                                                ...
                                                <textarea
                                                    ...
                                                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-400 rounded-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent resize-none text-sm dark:text-white"
